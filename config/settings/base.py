...
# civicvoice_backend/
APPS_DIR = BASE_DIR / "civicvoice_backend"
env = environ.Env()
...
LOCAL_APPS = [
    "civicvoice_backend.users",
    "civicvoice_backend.setting",
    "civicvoice_backend.complaints",
    "civicvoice_backend.dashboard",
...
MIGRATION_MODULES = {"sites": "civicvoice_backend.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "civicvoice_backend.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""foysaldev""", "foysaldev@civicvoice.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "civicvoice_backend.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "civicvoice_backend.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "civicvoice_backend.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "civicvoice_backend.users.forms.UserSocialSignupForm"}
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': env('JWT_SECRET_KEY', default='your-secret-key'),
    'ALGORITHM': 'HS256',
