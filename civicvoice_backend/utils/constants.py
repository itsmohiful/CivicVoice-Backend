...
timezones_file_path = os.path.join(settings.BASE_DIR, 'civicvoice_backend', 'assets', 'timezones.json')
...
currencies_file_path = os.path.join(settings.BASE_DIR, 'civicvoice_backend', 'assets', 'countries.json')
